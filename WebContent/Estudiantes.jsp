						...
						<table width="100%" border="0" cellspacing="4" cellpadding="4">
							...
							<tr>
								...
								<td><input type="text" name="correo" size="30"
									onkeypress="return sololetras(event)" placeholder="Correo"
									value="<%=correo != null ? correo : ""%>"></td>
								<td class="label">Plan de Estudios(*):</td>
								<td><input type="text" name="plan" size="20"
									placeholder="Plan de estudios"
									value="<%=plan != null ? plan : ""%>"></td>
							</tr>
							<tr>
								<td class="label">Semestre(*):</td>
								<td><input type="text" name="semestre" size="20"
									maxlength="5" onkeypress="return validar(event)"
								...
								<td><input type="text" name="perfil" size="20"
									maxlength="5" onkeypress="return validar(event)"
									placeholder="Perfil" value="<%=perfil != null ? perfil : ""%>"></td>
							</tr>
						</table>
					</td>
					<td class="caja_01_bottom">&nbsp;</td>
