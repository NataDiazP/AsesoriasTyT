...
<div id="ruta"> <h1> Gesti&oacute;n de Bloques</h1>
<br>
     ...
     <tr>
      ...
      <table width="100%" border="0" cellspacing="4" cellpadding="4">
          <tr>
            ...
            <td><input type="text" name="NombrePerfil"size="30" onkeypress="return sololetras(event)" placeholder="Encargado Bloque" ></td>
          </tr>
      </table>
      </td>
      <td class="caja_01_bottom">&nbsp;</td>
