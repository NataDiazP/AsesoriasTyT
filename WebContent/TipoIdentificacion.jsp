...
<title>Gesti&oacute;n de Tipo de Identificaci&oacute;n</title>
...
<br>
<br>
<div id="ruta"> <h1> Gesti&oacute;n  de Tipo de Identificaci&oacute;n</h1>
<br>
    ...
    <tr>
     ...
     <tr>
      ...
      <table width="100%" border="0" cellspacing="4" cellpadding="4">
          <tr>
            <td class="label">C&oacute;digo de Tipo de Identificaci&oacute;n(*):</td>
            <td><input type="text" name="IdPerfil" size="20"maxlength="5" onkeypress="return validar(event)"  placeholder="Código" ></td>
            <td class="label">Nombre de Tipo de Identificaci&oacute;n(*):</td>
            <td><input type="text" name="NombrePerfil"size="30" onkeypress="return sololetras(event)" placeholder="Nombre Tipo Identificación" ></td>
          </tr>
      </table>
      </td>
      <td class="caja_01_bottom">&nbsp;</td>
 ...
 <thead>
    ...
    <tr>
      ...
      <td valign="top" class="caja_01_bottom"><table width="100%" align="center" id="rounded-corner">
          <thead>
            <tr>
              <th class="rounded" scope="col">Código de Tipo de Identificaci&oacute;n</th>
              <th class="rounded" scope="col">Nombre de Tipo de Identificaci&oacute;n</th>
            </tr>
    </thead>
	<tbody>
