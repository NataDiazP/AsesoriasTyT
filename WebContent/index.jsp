...
<div id="menu">
		<iframe id="menu" frameborder="no" scrolling="auto" height="100%" width="200" marginheight=0 marginwidth=0 noResize src="Menu.jsp" style="position:absolute; left:1px; top:120px; z-index:5"> </iframe> </div>
