...
<%@page import="co.poli.asesoriastyt.model.GooglePlusUser"%>
<%@page import="java.util.List"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%			
			GooglePlusUser usuario= (GooglePlusUser)session.getAttribute("googlePlusUser");
			String mailDocente= usuario.getEmail();
			
			NAsesoria nAsesoria = new NAsesoria();
			DAOAsesorias dao = new DAOAsesorias();
			List<Asesoria> listaAsesorias = nAsesoria.ListadoAsesoriasProfesor(mailDocente);
		%>
<html>
<head>
