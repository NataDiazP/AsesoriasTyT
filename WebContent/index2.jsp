	...
	<div id="contenedor">
		...
		<div id="menu">
			<iframe id="menu" frameborder="no" scrolling="auto" height="100%"
				width="200" marginheight=0 marginwidth=0 noResize src="Menu2.jsp"
				style="position: absolute; left: 1px; top: 120px; z-index: 5">
			</iframe>
		</div>

		<div id="contenido">
			<iframe id="datos" name="datos" frameborder="0" scrolling="auto"
				height="0" width="100%" marginheight=80 marginwidth=0
				onload="autofitIframe(this);" noResize src="Bienvenida.jsp"
				style="background: transparent" allowtransparency="true"></iframe>
		</div>
	</div>
</body>
