...
<br>
<br>
<div id="ruta"> <h1> Gesti&oacute;n de Programaci&oacute;n Acad&eacute;mica</h1>
<br>
     ...
     <tr>
      ...
      <table width="100%" border="0" cellspacing="4" cellpadding="4">
          <tr>
            ...
            <td><input type="text" name="IdPerfil" size="20"maxlength="5" onkeypress="return validar(event)"  placeholder="Asignatura" value=""></td>
          </tr>
          <tr>
            <td class="label">Dias(*):</td>
            <td><input type="text" name="IdPerfil" size="20"maxlength="5" onkeypress="return validar(event)"  placeholder="Días" value=""></td>
          ...
          <tr>
            ...
            <td><input type="text" name="IdPerfil" size="20"maxlength="5" onkeypress="return validar(event)"  placeholder="Aula" value=""></td>
          </tr>
      </table>
      </td>
      <td class="caja_01_bottom">&nbsp;</td>
